...
function readMore1(){
    ...
    var btn = document.getElementById("btn-read-1");
...
function readMore2() {
    ...
    var btn2= document.getElementById("btn-read-2");
...
function readMore3() {
    ...
    var btn3= document.getElementById("btn-read-3");
...
function readMoreEvent(){
    var dotEvent = document.getElementById("dot-event");
    var readMore = document.getElementById("readMore");
    var more = document.getElementById("read");
    if(dotEvent.style.display === 'none'){
        dotEvent.style.display = 'inline';
        readMore.style.display = 'none';
        more.textContent = 'Read More'
    }
    else{
        dotEvent.style.display = 'none';
